      ...
      let
        ...
        release = {
          x86_64-linux = {
            ...
            hash = "sha256-wIBzWHfrZocIA9R+nR0TgVhmevi0FnWgEu1zx2oNlxg=";
          };
          aarch64-linux = {
            archive = "amaru-10.10.20260607-linux-aarch64.tar.gz";
            hash = "sha256-BkkCmdwRm+OMpOjY5ItXBvJCG2OPz0PusEAJYBUE0ps=";
          };
          aarch64-darwin = {
            archive = "amaru-10.10.20260607-macos-aarch64.tar.gz";
            hash = "sha256-esr8aQAHXyRaSK1AVg/uhPmnvqydhmdPmClkQwr8d/E=";
          };
        }.${system};
