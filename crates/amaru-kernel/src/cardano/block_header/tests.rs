...
pub fn make_header(block_number: u64, slot: u64, prev_hash: Option<Hash<HEADER>>) -> Header {
    use crate::Bytes;
...
fn make_headers_with_root_hash(
    header_hash: Option<Hash<HEADER>>,
...
pub fn any_header_with_parent(parent: Hash<HEADER>) -> impl Strategy<Value = BlockHeader> {
...
pub fn any_header_hash() -> impl Strategy<Value = Hash<HEADER>> {
