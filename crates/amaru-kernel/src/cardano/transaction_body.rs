...
impl TransactionBody {
    ...
    /// testing but unsuitable for production.
    #[cfg(any(test, feature = "test-utils"))]
    pub fn new(
        inputs: impl IntoIterator<Item = TransactionInput>,
        outputs: impl IntoIterator<Item = MemoizedTransactionOutput>,
        fee: Lovelace,
    ) -> Self {
        let mut body = Self {
