...
pub mod tests {
    use amaru_kernel::{
        ...
        MemoizedTransactionOutput, NetworkName, Point, PoolId, PoolParams, Slot, StakeCredential,
        TransactionInput, any_certificate_pointer, any_hash28, any_pool_params, any_proposal_id,
        any_stake_credential, protocol_parameters::PREPROD_INITIAL_PROTOCOL_PARAMETERS,
    };
    use amaru_ledger::{
        state::diff_bind,
        store::{
