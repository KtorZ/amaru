...
use amaru_kernel::{
    BlockHeader, Hash, IsHeader, NetworkMagic, Peer, Transaction, any_headers_chain_with_root,
    cbor, hash::size::HEADER, make_header, utils::tests::run_strategy,
};
...
fn initialize_chain_store(
    ...
    let origin_hash: Hash<HEADER> = amaru_kernel::Hash::from_str(
